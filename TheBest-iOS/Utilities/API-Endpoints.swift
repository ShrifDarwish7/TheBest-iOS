...
let ROAD_SERVICES_CATEGORIES_END_POINT = BASE_URL + "RoadService/RoadServCategories"
let ROAD_SERVICES_OPTIONS_END_POINT = BASE_URL + "RoadService/RoadServOptions/"
let ROAD_SERVICES_NEARST_CARS_END_POINT = BASE_URL + "RoadService/NearestRs"
let CONFIRM_RIDE_ROAD_SERVICES_END_POINT = BASE_URL + "RoadService/ConfirmRideRs"
let GET_DISTANCE_ROAD_SERVICES_END_POINT = BASE_URL + "RoadService/GetDistanceRs"
let SUB_TYPES_END_POINT = BASE_URL + "subscriptions/SubscriptionsTypes"
let SUB_CONFIRM_RIDE_END_POINT = BASE_URL + "subscriptions/ConfirmRideSubscription"
let GET_TRIP_BY_ID = "https://thebest-solution.com/Driver/Main/GetTripByID/"
let ALL_SHERA = BASE_URL + "shabra/AllShabra"
let SHERA_TYPES = BASE_URL + "shabra/Shabratypes"
let FILTER_SHERA = BASE_URL + "shabra/ShabraFilter"
let NEARBY_SHERA = BASE_URL + "shabra/nearByShera"
let CITIES_API = BASE_URL + "Cities"
let DISTRICTS_API = BASE_URL + "Districts/"
let SP_CANCEL_RIDE = BASE_URL + "SpecialCars/CancelRideSpCar"
let FURNITURE_CANCEL_RIDE = BASE_URL + "Truck/CancelRideTruck"
let CARS_CANCEL_RIDE = BASE_URL + "Car/CancelRideCar"
let RS_CANCEL_RIDE = BASE_URL + "RoadService/CancelRideRs"
let SUBSCRIPT_CANCEL_RIDE = BASE_URL + "subscriptions/CancelRideSubscription"
let SUBSCRIPT_DISTANCE = BASE_URL + "subscriptions/GetDistanceSubscription"
let MY_PROFILE = BASE_URL + "Me/MyProfile"
